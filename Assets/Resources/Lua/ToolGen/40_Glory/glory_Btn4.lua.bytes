...
---@class glory_Btn4 : CS.FairyGUI.GButton
...
glory_Btn4.URL = "ui://e1uzapmrnil";

function glory_Btn4:OnConstruct(windowCom)
	local tb = {
...
--self.uiComs=require('ToolGen.40_Glory.glory_Btn4'):OnConstruct(self.contentPane)