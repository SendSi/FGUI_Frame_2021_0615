...
---@class SeasonRecruitPreviewView : CS.FairyGUI.GLabel
...
local SeasonRecruitPreviewView = {};

SeasonRecruitPreviewView.URL = "ui://sinorujtnil";

function SeasonRecruitPreviewView:OnConstruct(windowCom)
	local tb = {
...
return SeasonRecruitPreviewView;

--self.uiComs=require('ToolGen.30_activity.SeasonRecruitPreviewView'):OnConstruct(self.contentPane)