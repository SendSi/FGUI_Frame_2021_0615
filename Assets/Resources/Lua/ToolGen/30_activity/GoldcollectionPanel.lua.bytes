...
---@class GoldcollectionPanel : CS.FairyGUI.GComponent
...
local GoldcollectionPanel = {};

GoldcollectionPanel.URL = "ui://sinorujtnil";

function GoldcollectionPanel:OnConstruct(windowCom)
	local tb = {
...
return GoldcollectionPanel;

--self.uiComs=require('ToolGen.30_activity.GoldcollectionPanel'):OnConstruct(self.contentPane)