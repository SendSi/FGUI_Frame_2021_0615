...
---@class FieldBossActPanel : CS.FairyGUI.GLabel
...
local FieldBossActPanel = {};

FieldBossActPanel.URL = "ui://sinorujtnil";

function FieldBossActPanel:OnConstruct(windowCom)
	local tb = {
...
return FieldBossActPanel;

--self.uiComs=require('ToolGen.30_activity.FieldBossActPanel'):OnConstruct(self.contentPane)