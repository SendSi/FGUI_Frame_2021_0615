...
---@class MysteryBookPanel : CS.FairyGUI.GLabel
...
local MysteryBookPanel = {};

MysteryBookPanel.URL = "ui://sinorujtnil";

function MysteryBookPanel:OnConstruct(windowCom)
	local tb = {
...
return MysteryBookPanel;

--self.uiComs=require('ToolGen.30_activity.MysteryBookPanel'):OnConstruct(self.contentPane)