...
---@class CheckpointResView : CS.FairyGUI.GLabel
---@field public __ui CS.FairyGUI.GLabel
---@field public m_state CS.FairyGUI.Controller
---@field public m_mask CS.FairyGUI.GComponent
---@field public m_n24 CS.FairyGUI.GButton
---@field public m_n25 CS.FairyGUI.GButton
...
--self.uiComs=require('ToolGen.07_DialogTip.CheckpointResView'):OnConstruct(self.contentPane)