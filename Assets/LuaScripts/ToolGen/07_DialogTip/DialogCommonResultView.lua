...
---@class DialogCommonResultView : CS.FairyGUI.GLabel
...
local DialogCommonResultView = {};

DialogCommonResultView.URL = "ui://utp01xianil";

function DialogCommonResultView:OnConstruct(windowCom)
	local tb = {
...
--self.uiComs=require('ToolGen.07_DialogTip.DialogCommonResultView'):OnConstruct(self.contentPane)