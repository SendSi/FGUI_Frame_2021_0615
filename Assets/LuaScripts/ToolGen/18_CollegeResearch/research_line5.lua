...
---@class research_line5 : CS.FairyGUI.GComponent
...
local research_line5 = {};

research_line5.URL = "ui://45o8gpfbnil";

function research_line5:OnConstruct(windowCom)
	local tb = {
...
return research_line5;

--self.uiComs=require('ToolGen.18_CollegeResearch.research_line5'):OnConstruct(self.contentPane)