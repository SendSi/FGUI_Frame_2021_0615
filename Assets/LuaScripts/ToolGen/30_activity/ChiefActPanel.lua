...
---@class ChiefActPanel : CS.FairyGUI.GComponent
...
ChiefActPanel.URL = "ui://sinorujtnil";

function ChiefActPanel:OnConstruct(windowCom)
	local tb = {
...
return ChiefActPanel;

--self.uiComs=require('ToolGen.30_activity.ChiefActPanel'):OnConstruct(self.contentPane)