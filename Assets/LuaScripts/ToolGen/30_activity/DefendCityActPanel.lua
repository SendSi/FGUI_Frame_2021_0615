...
---@class DefendCityActPanel : CS.FairyGUI.GLabel
...
local DefendCityActPanel = {};

DefendCityActPanel.URL = "ui://sinorujtnil";

function DefendCityActPanel:OnConstruct(windowCom)
	local tb = {
...
return DefendCityActPanel;

--self.uiComs=require('ToolGen.30_activity.DefendCityActPanel'):OnConstruct(self.contentPane)