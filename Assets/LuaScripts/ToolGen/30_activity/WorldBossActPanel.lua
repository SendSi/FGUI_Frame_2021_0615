...
---@class WorldBossActPanel : CS.FairyGUI.GLabel
...
local WorldBossActPanel = {};

WorldBossActPanel.URL = "ui://sinorujtnil";

function WorldBossActPanel:OnConstruct(windowCom)
	local tb = {
...
return WorldBossActPanel;

--self.uiComs=require('ToolGen.30_activity.WorldBossActPanel'):OnConstruct(self.contentPane)