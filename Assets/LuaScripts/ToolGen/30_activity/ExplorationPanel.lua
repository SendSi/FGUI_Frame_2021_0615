...
---@class ExplorationPanel : CS.FairyGUI.GLabel
...
local ExplorationPanel = {};

ExplorationPanel.URL = "ui://sinorujtnil";

function ExplorationPanel:OnConstruct(windowCom)
	local tb = {
...
--self.uiComs=require('ToolGen.30_activity.ExplorationPanel'):OnConstruct(self.contentPane)