...
---@class MainCityTipsView : CS.FairyGUI.GLabel
...
---@field public m_inforTitle1 CS.FairyGUI.GTextField
...
---@field public m_enterBtn CS.FairyGUI.GButton
...
--self.uiComs=require('ToolGen.03_main.MainCityTipsView'):OnConstruct(self.contentPane)