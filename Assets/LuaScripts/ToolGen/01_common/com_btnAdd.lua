...
---@class com_btnAdd : CS.FairyGUI.GButton
...
com_btnAdd.URL = "ui://2r331opvnil";

function com_btnAdd:OnConstruct(windowCom)
	local tb = {
...
--self.uiComs=require('ToolGen.01_common.com_btnAdd'):OnConstruct(self.contentPane)